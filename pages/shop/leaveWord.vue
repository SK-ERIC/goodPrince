<template>
	<view class="container">
		...
		<view class="comment-section">
			<!-- <view class="title">
				顾客有话说 {{ commentList.length }}
			</view> -->
			<view class="comment-list">
				<view v-if="commentList.length>0" class="comment-cont" v-for="(item, index) in commentList" :key="index">
				...
				<view v-if="commentList.length==0" class="nthing-section">
