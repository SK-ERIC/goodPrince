<template>
  <view :style="showPage ? 'opacity: 1;' : 'opacity: 0;'">
    ...
    >
      <view
        v-if="page == 'shop'"
        :class="page == 'shop' ? 'animation-fade' : ''"
      >
        <cu-shop
          v-if="shopId && !isShowScan"
          :shopIndex="shopInfo"
          :commentList="commentList"
          @changeLike="_changeLike"
          @changeFullText="_changeFullText"
          @switchPostComments="_switchPostComments"
        ></cu-shop>
      ...
      <view
        v-if="page == 'user'"
        :class="page == 'user' ? 'animation-fade' : ''"
      >
      ...
      tabbar: [
        {
          ...
          selectedIconPath:
            "https://wxhyx-cdn.aisspc.cn/static/tabIcon_shop_sel.png",
          title: "店家",
          page: "shop",
        },
        {
          ...
          selectedIconPath:
            "https://wxhyx-cdn.aisspc.cn/static/tabIcon_photo.png",
          title: "",
          page: "",
        },
        {
          ...
          selectedIconPath:
            "https://wxhyx-cdn.aisspc.cn/static/tabIcon_user_sel.png",
          title: "我的",
          page: "user",
        },
      ],
    ...
    changeTab(item) {
      ...
      if (item.page) {
        ...
        uni.chooseImage({
          ...
          sourceType: ["camera", "album"], //可以指定是相机还是相册，默认二者都有
